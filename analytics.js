(function() {
    ...
    var B, D, E = function(a) {
        ...
        for (var c = "", d = 0; ; ) {
            ...
            64 != f && (c += String.fromCharCode(g << 4 & 240 | f >> 2),
    ...
    var P = function(a, b, c) {
        ...
        t.history && t.history.replaceState && (L.test(b) || L.test(c)) && (a = y(a, "path"),
        b = d(b, "?"),
        c = d(c, "#"),
    ...
    function T(a, b, c) {
        for (var d = {}, e = {}, g = I().decorators, f = 0; f < g.length; ++f) {
            var h = g[f];
            (!c || h.forms) && H(h.domains, b) && (h.fragment ? n(e, h.callback()) : n(d, h.callback()))
        }
        q(d) && (b = N(d),
        c ? U(b, a) : V(b, a, !1));
        !c && q(e) && (c = N(e),
    ...
    function V(a, b, c) {
        b.href && (a = S(a, b.href, void 0 === c ? !1 : c),
        r.test(a) && (b.href = a))
    }
    function U(a, b) {
        if (b && b.action) {
...
(function() {
    ...
    var Fa, Ga, fb, Ab, ja = /^https?:\/\/[^/]*cdn\.ampproject\.org\//, Ue = /^(?:www\.|m\.|amp\.)+/, Ub = [], da = function(a) {
        ...
        if (b && !1 !== a[Kd] && (void 0 === Ab && (b = (b = De.get()) && b._ga || void 0) && (Ab = b,
        J(81)),
        void 0 !== Ab))
            return a[Q] || (a[Q] = Ab),
            !1;
    ...
    var oe = function() {
      ...
      , ge = function(a, b, c) {
        1 <= 100 * Math.random() || G("?") || (a = ["t=error", "_e=" + a, "_v=j72", "sr=1"],
        b && a.push("_f=" + b),
      ...
      , Jc = function(a, b) {
        ...
        c || g))
            ...
            a.get(bc)) {
                ...
                e._gid && (J(51),
                a.data.set(I, e._gid)),
                e._gac && (d = e._gac.split(".")) && 2 == d.length && (J(37),
                a.data.set(ce, d[0]),
                a.data.set(fe, d[1]))),
                c)
                    b: if (d = c.indexOf("."),
